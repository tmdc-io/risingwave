...
public class PostgresSchemaFactory extends SchemaFactory {
    ...
    private static final PostgresSchemaFactory postgresSchemaFactoryObject =
            new PostgresSchemaFactory();
     ...
     */
    private static final String POSTGRES_LOGICAL_DECODING_MESSAGE_MONITOR_KEY_SCHEMA_NAME =
    ...
    private static final String POSTGRES_LOGICAL_DECODING_MESSAGE_MONITOR_BLOCK_SCHEMA_NAME =
            "io.debezium.connector.postgresql.Message";
    private static final int POSTGRES_LOGICAL_DECODING_MESSAGE_MONITOR_BLOCK_SCHEMA_VERSION = 1;

    private static final String POSTGRES_LOGICAL_DECODING_MESSAGE_MONITOR_VALUE_SCHEMA_NAME =
    ...
    public Schema logicalDecodingMessageMonitorKeySchema(SchemaNameAdjuster adjuster) {
        return SchemaBuilder.struct()
                ...
                .field(
                        LogicalDecodingMessageMonitor.DEBEZIUM_LOGICAL_DECODING_MESSAGE_PREFIX_KEY,
                        Schema.OPTIONAL_STRING_SCHEMA)
                .build();
    }

    public Schema logicalDecodingMessageMonitorBlockSchema(
        ...
        return SchemaBuilder.struct()
                ...
                .field(
                        ...
                        Schema.OPTIONAL_STRING_SCHEMA)
                .field(
                        LogicalDecodingMessageMonitor.DEBEZIUM_LOGICAL_DECODING_MESSAGE_CONTENT_KEY,
                        binaryHandlingMode.getSchema().optional().build())
                .build();
    }
    ...
    public Schema logicalDecodingMessageMonitorValueSchema(
        ...
        return SchemaBuilder.struct()
                ...
                .field(
                        LogicalDecodingMessageMonitor.DEBEZIUM_LOGICAL_DECODING_MESSAGE_KEY,
                        logicalDecodingMessageMonitorBlockSchema(adjuster, binaryHandlingMode))
                .build();
    }

    public SchemaBuilder datatypeLtreeSchema() {
        return SchemaBuilder.string().name(Ltree.LOGICAL_NAME).version(Ltree.SCHEMA_VERSION);
    }
}

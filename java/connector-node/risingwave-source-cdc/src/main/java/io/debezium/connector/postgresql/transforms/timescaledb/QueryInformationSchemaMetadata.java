...
/**
 * TimescaleDB metadata registry that performs out-of-band queries of TimescaleDB catalog to get the
 * mappings between chunks, hypertables and aggregates.
 *
...
public class QueryInformationSchemaMetadata extends AbstractTimescaleDbMetadata {
    ...
    private static final Logger LOGGER =
            LoggerFactory.getLogger(QueryInformationSchemaMetadata.class);
        ...
        connection =
                new PostgresConnection(
                        JdbcConfiguration.adapt(
                                config.subset(CommonConnectorConfig.DATABASE_CONFIG_PREFIX, true)
                                        .merge(
                                                config.subset(
                                                        CommonConnectorConfig.DRIVER_CONFIG_PREFIX,
                                                        true))),

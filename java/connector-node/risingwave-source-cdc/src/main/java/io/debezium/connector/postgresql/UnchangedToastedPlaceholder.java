 ...
 *
 * <p>The configured placeholder is converted to a data type that is compatible with the given
 * column type.
 *
...
public class UnchangedToastedPlaceholder {
    ...
    public UnchangedToastedPlaceholder(PostgresConnectorConfig connectorConfig) {
        ...
        final List<Integer> toastedIntArrayPlaceholder =
                new ArrayList<>(toastPlaceholderBinary.length);
        final List<Long> toastedLongArrayPlaceholder =
                new ArrayList<>(toastPlaceholderBinary.length);
        ...
        placeholderValues.put(
                ...
                Arrays.asList(toastPlaceholderUuid));
    }

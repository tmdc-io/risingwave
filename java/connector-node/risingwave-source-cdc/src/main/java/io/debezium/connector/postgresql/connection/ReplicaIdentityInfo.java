...
/**
 * Class to encapsulate {@link ReplicaIdentityInfo.ReplicaIdentity} enumerator, adding the name of
 * the index in case of the Replica Identity was set to `INDEX`
 *
...
public class ReplicaIdentityInfo {
    ...
    public String toString() {
        return indexName != null
                ? String.format("USING INDEX %s", indexName)
                : this.replicaIdentity.name();
    }

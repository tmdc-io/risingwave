...
public class PostgresTransactionMonitor extends TransactionMonitor {
    ...
    public PostgresTransactionMonitor(
    ...
    @Override
    protected Struct prepareTxStruct(
            OffsetContext offsetContext, long dataCollectionEventOrder, Struct value) {
        return adjustTxId(
                super.prepareTxStruct(offsetContext, dataCollectionEventOrder, value),
                offsetContext);
    }

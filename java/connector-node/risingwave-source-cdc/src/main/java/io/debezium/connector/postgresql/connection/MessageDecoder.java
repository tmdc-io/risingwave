...
public interface MessageDecoder {
    ...
    /**
     * Allows MessageDecoder to configure options with which the replication stream is started. See
     * PostgreSQL command START_REPLICATION SLOT for more details.
     *
     * @param builder
     * @return the builder instance
     */
    ChainedLogicalStreamBuilder defaultOptions(

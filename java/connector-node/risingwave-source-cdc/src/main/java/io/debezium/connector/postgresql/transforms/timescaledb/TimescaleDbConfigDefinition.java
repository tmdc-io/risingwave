...
public class TimescaleDbConfigDefinition {
    ...
    static final Field SCHEMA_LIST_NAMES_FIELD =
            Field.create(SCHEMA_LIST_NAMES_CONF)
                    ...
                    .withDescription(
                            "Comma-separated list schema names that contain TimescaleDB data tables, defaults to: '"
                                    + SCHEMA_LIST_NAMES_DEFAULT
                                    + "'");

    static final Field TARGET_TOPIC_PREFIX_FIELD =
            Field.create(TARGET_TOPIC_PREFIX_CONF)
                    ...
                    .withDescription(
                            "The namespace (prefix) of topics where TimescaleDB events will be routed, defaults to: '"
                                    + SCHEMA_LIST_NAMES_DEFAULT
                                    + "'");
}

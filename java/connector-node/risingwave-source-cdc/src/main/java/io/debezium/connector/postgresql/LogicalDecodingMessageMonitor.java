...
public class LogicalDecodingMessageMonitor {
    ...
    public LogicalDecodingMessageMonitor(
        ...
        this.keySchema =
                PostgresSchemaFactory.get()
                        .logicalDecodingMessageMonitorKeySchema(schemaNameAdjuster);
        ...
        this.blockSchema =
                PostgresSchemaFactory.get()
                        .logicalDecodingMessageMonitorBlockSchema(schemaNameAdjuster, binaryMode);

        this.valueSchema =
                PostgresSchemaFactory.get()
                        .logicalDecodingMessageMonitorValueSchema(
                                schemaNameAdjuster, connectorConfig, binaryMode);
    }
